...
[CC BY 4.0 licence](https://creativecommons.org/licenses/by/4.0/). The PDF
contains the CrossMark logo, its end-user licence, and a DOI link to the formal
publication on ScienceDirect, as required by Elsevier's
